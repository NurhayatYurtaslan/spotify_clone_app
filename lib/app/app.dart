    ...
    return BlocProvider(
      ...
      child: BlocBuilder<ChooseModeViewModel, ChooseModeState>(
        builder: (context, state) {
          final themeData = context.read<ChooseModeViewModel>().currentTheme; // Directly read current theme
          return MaterialApp.router(
            debugShowCheckedModeBanner: false,
            theme: AppTheme.lightTheme,
            darkTheme: AppTheme.darkTheme,
            themeMode: themeData.brightness == Brightness.dark ? ThemeMode.dark : ThemeMode.light, // Use the theme
            routerConfig: _appRouter.config(navigatorObservers: () => [NavigatorObserver()]),
          );
        },
      ),
    );
